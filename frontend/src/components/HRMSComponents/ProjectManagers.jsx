          ...
          {employees.map(emp => (
            <div
              ...
              style={{
                ...
                cursor: "pointer",
                transition: "all 0.2s ease",
                background: selectedEmployees.includes(emp._id) ? "#f0f9ff" : "#fff",
                borderColor: selectedEmployees.includes(emp._id) ? "#0ea5e9" : "#e2e8f0"
              }}
              onMouseEnter={(e) => {
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div
                  style={{
                    ...
                    background: selectedEmployees.includes(emp._id) ? "#0ea5e9" : "#fff",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    flexShrink: 0
      ...
      <div style={{ display: "flex", gap: "10px" }}>
        <button
          ...
          style={{
            flex: 1,
            padding: "12px",
            background: selectedEmployees.length > 0 ? "#10b981" : "#e5e7eb",
        ...
        >
          Assign {selectedEmployees.length > 0 ? `${selectedEmployees.length} Employee${selectedEmployees.length !== 1 ? 's' : ''}` : 'Employees'}
        </button>
          ...
          {managers.map((manager) => (
            <div
              ...
              style={{
                ...
                cursor: "pointer",
                transition: "all 0.2s ease",
                background: selectedManager?._id === manager._id ? "#f0f9ff" : "#fff",
                borderColor: selectedManager?._id === manager._id ? "#0ea5e9" : "#e2e8f0"
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = "translateY(-1px)";
                e.currentTarget.style.boxShadow = "0 2px 8px rgba(0,0,0,0.1)";
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: "12px", color: "#94a3b8" }}>
                    ID: {manager._id ? manager._id.slice(-8).toUpperCase() : 'N/A'}
                  </div>
                </div>
