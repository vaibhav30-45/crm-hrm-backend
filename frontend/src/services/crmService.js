...
export const crmService = {
  ...
  activities: {
    getAll: async (params = {}) => {
      ...
      return await api.get(
        `/crm/activities${queryString ? `?${queryString}` : ""}`,
      );
    },
  ...
  deals: {
    getAll: async () => {
      return await api.get("/crm/deals");
    },
    create: async (dealData) => {
      return await api.post("/crm/deals", dealData);
    },
    updateStage: async (id, stage) => {
      return await api.put(`/crm/deals/${id}/stage`, { stage });
    },
    delete: async (id) => {
  ...
  reports: {
    getDashboardStats: async () => {
      return await api.get("/crm/reports/dashboard-stats");
    },
  },
};
